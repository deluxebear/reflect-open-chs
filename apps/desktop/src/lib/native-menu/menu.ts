  ...
  return [
    {
      ...
      entries: [
        ...
        separator(),
        predefined('Services', t('commands:menu.services', { defaultValue: 'Services' })),
        separator(),
        predefined('Hide', t('commands:menu.hide', { defaultValue: 'Hide Reflect' })),
        predefined(
          'HideOthers',
          t('commands:menu.hideOthers', { defaultValue: 'Hide Others' }),
        ),
        predefined('ShowAll', t('commands:menu.showAll', { defaultValue: 'Show All' })),
        separator(),
    ...
    },
    {
      ...
      entries: [
        ...
        predefined(
          'CloseWindow',
          t('commands:menu.closeWindow', { defaultValue: 'Close' }),
        ),
      ],
    },
    {
      ...
      entries: [
        predefined('Undo', t('commands:menu.undo', { defaultValue: 'Undo' })),
        predefined('Redo', t('commands:menu.redo', { defaultValue: 'Redo' })),
        separator(),
        predefined('Cut', t('commands:menu.cut', { defaultValue: 'Cut' })),
        predefined('Copy', t('commands:menu.copy', { defaultValue: 'Copy' })),
        predefined('Paste', t('commands:menu.paste', { defaultValue: 'Paste' })),
        predefined(
          'SelectAll',
          t('commands:menu.selectAll', { defaultValue: 'Select All' }),
        ),
      ],
    },
    {
    ...
    },
    {
      ...
      entries: [
        ...
        predefined(
          'Minimize',
          t('commands:menu.minimize', { defaultValue: 'Minimize' }),
        ),
        predefined('Maximize', t('commands:menu.zoom', { defaultValue: 'Zoom' })),
        separator(),
        predefined(
          'BringAllToFront',
          t('commands:menu.bringAllToFront', { defaultValue: 'Bring All to Front' }),
        ),
      ],
    },
    {
