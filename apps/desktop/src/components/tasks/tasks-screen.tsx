      ...
      <header className="flex flex-none items-center gap-2 border-b border-border py-2.5 pl-2 pr-3 lg:pl-10">
        ...
        {selection.selectedCount > 0 ? (
          ...
          >
            <Button
              type="button"
              variant="ghost"
              aria-label={t('scheduleAria', { count: selection.selectedCount })}
        ...
        {selection.selectedCount > 0 ? (
          <Button
            type="button"
            variant="ghost"
            aria-label={t('convertToBulletAria', { count: selection.selectedCount })}
            onClick={onConvertToBullet}
            title={t('convertToBulletTitle')}
            className="window-drag-control text-xs text-text-muted"
          >
        ...
        {recentlyCompleted.length > 0 ? (
          <Button
            type="button"
            variant="ghost"
            aria-label={t('archiveAria', { count: recentlyCompleted.length })}
