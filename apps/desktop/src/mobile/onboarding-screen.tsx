      ...
      <div className="mx-auto flex w-full max-w-md flex-col gap-7 py-6">
        <header className="flex flex-col gap-4 pt-2">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm leading-6 text-text-secondary">{t('onboarding.subtitle')}</p>
          </div>
        </header>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col items-center gap-1 px-4 text-center">
            ...
            >
              ...
              {pendingChoice === 'local' ? t('onboarding.settingUp') : t('onboarding.localOnly')}
            </Button>
          </div>
        </div>
...
function IcloudUnavailableSection(): ReactElement {
  ...
  return (
    <section className="flex flex-col gap-3 rounded-lg border border-border bg-surface p-4">
      <OnboardingIcloudHeader description={t('onboarding.icloudUnavailableDesc')} />
      <p className="rounded-lg bg-muted/60 px-3 py-2 text-xs leading-5 text-text-muted">
        {t('onboarding.icloudSignIn')}
      </p>
    </section>
  )
}
